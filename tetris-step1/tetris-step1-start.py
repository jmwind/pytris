...
# Fill in this method so that the boxes on the board fall
# to the bottom of the playing area and stack on top of each
# other like they would do in a tetris game
